    ...
    <div style="width: 100%;">
        <div class="layui-carousel lunbotuDiv" id="test1" lay-filter="test1">
            <div carousel-item>
                <div>
                    <a href="javascript:">
                        <img src="file/video/images/lunbo/gongfu.jpg" width="100%" height="400px" alt="功夫">
                    </a>
                </div>
                <div>
                    <a href="javascript:">
                        <img src="file/video/images/lunbo/sdtw.jpg" alt="狄仁杰2四大天王" width="100%" height="400px">
                    </a>
                </div>
                <div>
                    <a href="javascript:">
                        <img src="file/video/images/lunbo/guochuntian.jpg" alt="过春天" width="100%" height="400px">
                    </a>
                </div>
                <div>
                    <a href="javascript:">
                        <img src="file/video/images/lunbo/szyz.jpg" alt="慎重勇者" width="100%" height="400px">
                    </a>
                </div>
                <div>
                    <a href="javascript:">
                        <img src="file/video/images/lunbo/crgzs.jpg" alt="超人高中生们" width="100%" height="400px">
                    </a>
                </div>
            </div>
            <a name="skip"></a>
